...
const Footer = () => {
  ...
  return (
    <footer className="bg-midnight-950 dark:bg-midnight-950 border-t-4 border-gold py-16 relative overflow-hidden tibeb-pattern">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            <div className="flex items-center space-x-2 text-midnight-900 dark:text-white font-bold text-xl tracking-tight">
               <div className="w-10 h-10 bg-gold rounded-lg flex items-center justify-center text-midnight-950 shrink-0 shadow-lg shadow-gold/20 font-serif">ያ</div>
               <span>Yanit<span className="text-gold">.</span></span>
            </div>
          ...
          <div className="flex items-center space-x-6 text-zinc-400 dark:text-midnight-400">
             <a href="#" className="hover:text-gold dark:hover:text-gold transition-all duration-300 transform hover:-translate-y-1">
                <Github size={22} />
             </a>
             <a href="#" className="hover:text-gold dark:hover:text-gold transition-all duration-300 transform hover:-translate-y-1">
                <Linkedin size={22} />
          ...
          <Link
            ...
            smooth={true}
            duration={500}
            className="p-3 bg-white dark:bg-midnight-900 rounded-full border border-zinc-100 dark:border-white/10 text-gold hover:bg-gold hover:text-midnight-950 transition-all duration-300 cursor-pointer shadow-lg group relative"
          >
